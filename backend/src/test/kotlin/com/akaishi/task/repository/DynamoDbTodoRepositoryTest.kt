...
class DynamoDbTodoRepositoryTest {
    protected companion object {
        ...
        var dynamoBcClient: DynamoDbClient
        ...
        init {
            ...
            dynamoBcClient = DynamoDbClient.builder()
            ...
            val createTableRequest =
                CreateTableRequest
                    ...
                    .build()
            dynamoBcClient.createTable(createTableRequest)
            ...
            val describeTableRequest =
                DescribeTableRequest
                    ...
                    .tableName(TEST_TABLE_NAME)
                    .build()
            dynamoBcClient.waiter().waitUntilTableExists(describeTableRequest)
        }
    }
}
